package com.example.princeps.heartratemonitor;
...
//			addY=250;
            ...
            if(gx<200){
                if(hua[20]>1){
                    Toast.makeText(MainActivity.this, "put your finger on camera", Toast.LENGTH_SHORT).show();
                    hua[20]=0;}
                hua[20]++;
                return;}
            else
    ...
    private static PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            //
            int imgAvg = FigureCompare.decodeYUV420SPtoRedAvg(data.clone(),height,width);
            gx=imgAvg;
            text1.setText("pixel value is "+String.valueOf(imgAvg));
            //
            ...
            if (imgAvg < rollingAverage) {
                ...
                if (newType != currentType) {
                    beats++;
                    flag=0;
                    text2.setText("pulse "+String.valueOf(beats));
...
//
            ...
            if (totalTimeInSecs >= 2) {
                ...
                text.setText("Heart Rate is "+String.valueOf(beatsAvg)+"  "+String.valueOf(beatsArray.length)
